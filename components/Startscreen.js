    ...
    return (
      ...
      <TouchableOpacity onPress= {this.goToMain}><Text style= {news.Text1}>Services </Text></TouchableOpacity>
       <TouchableOpacity onPress= {this.goToMain}><Text style= {news.Text2}>Map </Text></TouchableOpacity>
        ...
        <TouchableOpacity onPress= {this.goToFAQ}><Text style= {news.Text5}>FAQs </Text></TouchableOpacity>
      ...
      />
        ...
        source={require('../assets/e04e8f6d8e18e6ae1e01ff3586c3a378-frontal-face-mask-illustration.png')}
      />
     </View>
    )
    }
